...
// Proses submit pengajuan anggaran
$error = '';
$success = '';
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    // Hapus titik ribuan, tetap sebagai integer
    $nominal = (int) str_replace('.', '', $nominal_raw);
    ...
    if($keterangan == '' || $nominal <= 0){
        ...
        $stmt_insert->bind_param("issi", $uid, $tanggal, $keterangan, $nominal);
...
<div class="container mt-4">
    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            <form method="POST" id="form-anggaran">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nominal" id="nominal" class="form-control" placeholder="contoh: 100.000" required>
                </div>
...
<!-- JS untuk auto format ribuan saat input -->
<script>
